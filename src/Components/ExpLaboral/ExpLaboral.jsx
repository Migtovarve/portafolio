                    ...
                    <div className="md:flex flex-start min-w-16 xl:text-lg">
                        ...
                        <div className="block p-6 rounded-lg shadow-lg bg-gray-100 max-w-md ml-6 mb-10">
                            <div className="flex justify-between mb-4 ">
                                ...
                                <p  className="font-medium text-primary hover:text-primary focus:text-primary duration-300 transition ease-in-out text-sm xl:text-lg">Asistente de enseñanza Full-Stack</p>
