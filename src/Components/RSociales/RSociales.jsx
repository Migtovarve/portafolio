...
export default function RSociales() {
    return (
        <div className="flex justify-center space-x-6 pt-10">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" className="w-8 h-8 text-primary">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="w-8 h-8 text-primary">
