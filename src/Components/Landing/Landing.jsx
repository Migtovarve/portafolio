...
export default function Landing() {
    return (
        <div className='grid grid-cols-2 h-screen w-screen container'>
            <div className="flex flex-col justify-center items-center flex-wrap">
                <h1 className="text-3xl font-bold text-primary">Hola! Soy Miguel Tovar</h1>
                <h5 className="text-lg text-primary">Full Stack Web Developer</h5>
                <p></p> 
                <div className="flex">
            ...
            <div className="flex flex-col justify-center items-center">
                <img className="rounded-full h-96 w-96 border border-1 border-primary" src={perfil}  />

                <div class="flex justify-center space-x-6 pt-10">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" className="w-7 h-7 text-primary">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="w-7 h-7 text-primary">
